...
#ifndef __FU68XX_3_MCU_H__
#define __FU68XX_3_MCU_H__

/******************************************************************************///Including Header Files
#include <FU68xx_3_Type.h>
/******************************************************************************///Define Macro
#define MCU_FREQ                        (24000000)                              // MCU工作频率
/******************************************************************************///Function Subject
...
/******************************************************************************///RST
 ...
 #define SOFTRST                                  0x01                          //           rw1- 软件复位使能和软件复位标志
/******************************************************************************///RTC
 ...
 #define ESOAE                                    0x08
 #define ESOEN                                    0x04
 #define CAL_CR                         *(_IO uint16 xdata*)0x4044
...
/******************************************************************************///UART
 ...
 #define UT2xBAUD                                 0x8000                        //           rw--波特率倍频使能
 ...
 #define UT22xBAUD                                0x8000                        //           rw-- 波特率倍频使能
 #define UT2CH                                    0x4000                        //           rw-- 端口功能转移
 #define UT2IE                                    0x2000                        //           rw-- 中断使能
/******************************************************************************///MDU
 ...
 sfr16   MDU_C                          = 0xc2;                                 // RV:0000H
 sfr16   MDU_B                          = 0xc4;                                 // RV:0000H
 sfr16   MDU_A                          = 0xc6;                                 // RV:0000H

 sfr     MDU_MD                         = 0xca;                                 // RV:  00H
 #define MDUMOD2                                  0x04                          //           rw-- MDU模式配置2
 #define MDUMOD1                                  0x02                          //           rw-- MDU模式配置1
 #define MDUMOD0                                  0x01                          //           rw-- MDU模式配置0

 sfr     MDU_D                          = 0xcb;                                 // RV:  00H
/******************************************************************************///PI
 sfr16   PI_EK1                         = 0xe2;                                 // RV:0000H  上一次的误差
 sfr16   PI_UKS                         = 0xe4;                                 // RV:0000H  结果低16位输出
 sfr16   PI_EK                          = 0xea;                                 // RV:0000H  误差输入
 sfr16   PI_UK                          = 0xec;                                 // RV:0000H  结果高16位输出
 ...
 #define T2RPD                                    0x40                          //
 #define PIRANGE                                  0x04                          //           rw-- PI标幺格式
 #define PISTA                                    0x02                          //           rw-- PI使能和PI状态
/******************************************************************************///FOC
 ...
 #define FOC__UDCFLT                    *(_IO  int16 xdata*)0x4098              // RV:0000H  滤波后的母线电压
...
/******************************************************************************///TIM1
 ...
 #define TIM1__ITRIP                    *(_IO uint16 xdata*)0x4098              // RV:0000H  滤波后的母线电流
...
/******************************************************************************///PFC
 #define PFC__UAC                       *(_I   int16 xdata*)0x409a              // RV:0000H  UAC采样值
 #define PFC__IAC                       *(_I   int16 xdata*)0x409c              // RV:0000H  IAC采样值

 #define PFC_CR2                        *(_IO  uint8 xdata*)0x409e              // RV:  00H  PFC控制寄存器2
 #define UDCPISTA                                 0x80                          //           w--- UDC的pi软件启动
 #define IACPISTA                                 0x40                          //           w--- IAC的pi软件启动
 #define P2FTEN                                   0x20                          //           rw-- PFC的ADC值自动load到FOC的EALPHA/EBETA
 #define DCLREN                                   0x10                          //           rw-- DRV的计数器可请PFC的计数器，用于两计数器同步
 #define PIAUTOEN                                 0x08                          //           rw-- PI自动启动
 #define ADTRIGEN                                 0x04                          //           rw-- ADC自动启动
 #define DRALEN                                   0x02                          //           rw-- 计数器的DR自动更新
 #define PFCCEN                                   0x01                          //           rw-- 计数器使能

 #define PFC_CR0                        *(_IO  uint8 xdata*)0x40e0              // RV:  00H  PFC控制寄存器0
 #define UAVGCSW                                  0x80                          //           w--- 软件启动算UAVG
 #define CMP5DIV1                                 0x40                          //           rw-- 比较器滤波选择1
 #define CMP5DIV0                                 0x20                          //           rw-- 比较器滤波选择0
 #define UAVGCDIS                                 0x10                          //           rw-- 硬件自动算UAVG禁止
 #define PFCOA                                    0x08                          //           rw-- 逐波限流恢复使能
 #define CCHSEL                                   0x04                          //           rw-- ADC校准通道选择
 #define PFCOE                                    0x02                          //           rw-- PFC输出使能,P03
 #define PFCEN                                    0x01                          //           rw-- PFC使能

 #define PFC_ADCCH                      *(_IO  uint8 xdata*)0x40e1              // RV:0000H  UAC/IAC的ADC通道选择
 #define PFC_CSO                        *(_IO  int16 xdata*)0x40e2              // RV:0000H  UAC/IAC的基准值
 #define PFC_ARR                        *(_O  uint16 xdata*)0x40e4              // RV:0000H  PFC的计数器重载值
 #define PFC__UAVG                      *(_I   int16 xdata*)0x40e4              // RV:0000H  UAC的平均值
 #define PFC__DR                        *(_IO uint16 xdata*)0x40e6              // RV:0000H  PFC的计数器比较值
 #define UDC_REF                        *(_IO  int16 xdata*)0x40e8              // RV:0000H  UDC的PI参考值
 #define UDC__UK                        *(_IO  int16 xdata*)0x40ea              // RV:0000H  UDC的PI输出值
 #define UDC_KP                         *(_IO  int16 xdata*)0x40ec              // RV:0000H  UDC的PI的比例参数
 #define UDC_KI                         *(_IO  int16 xdata*)0x40ee              // RV:0000H  UDC的PI的积分参数
 #define UDC_UKMAX                      *(_IO  int16 xdata*)0x40f0              // RV:0000H  UDC的PI最大输出值
 #define UDC_UKMIN                      *(_IO  int16 xdata*)0x40f2              // RV:0000H  UDC的PI最小输出值

 #define PFC_CR1                        *(_IO  uint8 xdata*)0x40f2              // RV:  00H  PFC控制寄存器1
 ...
 #define PFC_KM                         *(_IO  uint8 xdata*)0x40f3              // RV:0000H  PFC的KM系数
 #define IAC__REF                       *(_IO  int16 xdata*)0x40f4              // RV:0000H  IAC的PI参考值
 #define IAC__UK                        *(_IO  int16 xdata*)0x40f6              // RV:0000H  IAC的PI输出值
 #define IAC_KP                         *(_IO  int16 xdata*)0x40f8              // RV:0000H  IAC的PI的比例参数
 #define IAC_KI                         *(_IO  int16 xdata*)0x40fa              // RV:0000H  IAC的PI的积分参数
 #define IAC_UKMAX                      *(_IO  int16 xdata*)0x40fc              // RV:0000H  IAC的PI最大输出值
 #define IAC_UKMIN                      *(_IO  int16 xdata*)0x40fe              // RV:0000H  IAC的PI最小输出值
 #define PFC_OUTARR                     *(_IO  int16 xdata*)0x40fe              // RV: 000H      PFC外环执行频率，只使用寄存器低12位
 #define PFC_TRGDLY                     *(_IO  uint8 xdata*)0x40fe              // RV:  0xH  PFC采样延迟，只使用寄存器高4位
/******************************************************************************///WDT
...
/******************************************************************************///GPIO
 ...
 #define UT1EN                                    0x40                          //           rw-- UART1使能
 #define UT2EN                                    0x20                          //           rw-- UART2使能
...
/******************************************************************************///ADC
 ...
 #define ADC0_DR                        *(_I  uint16 xdata*)0x0600              // RV:0000H  ADC通道0转换结果
 #define ADC1_DR                        *(_I  uint16 xdata*)0x0602              // RV:0000H  ADC通道1转换结果
 #define ADC2_DR                        *(_I  uint16 xdata*)0x0604              // RV:0000H  ADC通道2转换结果
 #define ADC3_DR                        *(_I  uint16 xdata*)0x0606              // RV:0000H  ADC通道3转换结果
 #define ADC4_DR                        *(_I  uint16 xdata*)0x0608              // RV:0000H  ADC通道4转换结果
 #define ADC5_DR                        *(_I  uint16 xdata*)0x060a              // RV:0000H  ADC通道5转换结果
 #define ADC6_DR                        *(_I  uint16 xdata*)0x060c              // RV:0000H  ADC通道6转换结果
 #define ADC7_DR                        *(_I  uint16 xdata*)0x060e              // RV:0000H  ADC通道7转换结果
 #define ADC8_DR                        *(_I  uint16 xdata*)0x0610              // RV:0000H  ADC通道8转换结果
 #define ADC9_DR                        *(_I  uint16 xdata*)0x0612              // RV:0000H  ADC通道9转换结果
 #define ADC10_DR                       *(_I  uint16 xdata*)0x0614              // RV:0000H  ADC通道10转换结果
 #define ADC11_DR                       *(_I  uint16 xdata*)0x0616              // RV:0000H  ADC通道11转换结果
 #define ADC12_DR                       *(_I  uint16 xdata*)0x0618              // RV:0000H  ADC通道12转换结果
 #define ADC13_DR                       *(_I  uint16 xdata*)0x061a              // RV:0000H  ADC通道13转换结果
/******************************************************************************///DAC
 #define DAC_CR                         *(_IO  uint8 xdata*)0x4035              // RV:  00H  DAC控制寄存器
 #define DACEN                                    0x80                          //           rw-- DAC0和DAC1使能
 #define DACMOD                                   0x40                          //           rw-- DAC模式配置
 #define DAC2EN                                   0x02                          //           rw-- DAC2使能

 #define DAC2_DR                        *(_IO  uint8 xdata*)0x4049              // RV:  00H  DAC2 8位数据输入
 #define DAC1_DR                        *(_IO  uint8 xdata*)0x404a              // RV:  00H  DAC0低1位数据和DAC1数据输入
 #define DAC0_DR                        *(_IO  uint8 xdata*)0x404b              // RV:  00H  DAC0高8位数据输入
/******************************************************************************///DMA
 ...
 #define DMA0_BARR                      *(_IO uint16 xdata*)0x403e              // RV:0000H  DMA通道0传输地址配置
 #define DMA1_BARR                      *(_IO uint16 xdata*)0x4040              // RV:0000H  DMA通道1传输地址配置
/******************************************************************************///VREF & VHALF
...
/******************************************************************************///CMP
 ...
 #define CMP5OUT                                  0x40                          //           rw-- CMP4比较结果
 #define CMP0FS                                   0x02                          //           rw-- CMP1/2功能转移使能
 #define CMP5EN                                   0x01                          //           rw-- CMP5使能
...
/******************************************************************************///FLASH
 ...
 #define FLAPRE									  0x04							//           rw-- FLASH扇区预编程使能
