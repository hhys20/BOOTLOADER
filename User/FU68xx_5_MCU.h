...
/******************************************************************************///IRQ
 ...
 #define PLVW1                                    0x02                          //               rw-- LVW优先级配置1
 #define PLVW0                                    0x01                          //               rw-- LVW优先级配置0
...
/******************************************************************************///MDU
 ...
 #define MDUSTA2                                  0x20                          //               rw-- 当使能SMDU时, 用于表示启动计算单元2   //sfr     MDU_MD                         = 0xca;                                 // RV:  00H  MDU模式配置
 #define MDUSTA1                                  0x10                          //               rw-- 当使能SMDU时, 用于表示启动计算单元1   //#define MDUMOD2                                  0x04                          //               rw-- MDU模式配置2
 #define MDUSTA0                                  0x08                          //               rw-- 当使能SMDU时, 用于表示启动计算单元0   //#define MDUMOD1                                  0x02                          //               rw-- MDU模式配置1
 #define MDUMOD2                                  0x04                          //               rw-- 当使能SMDU时, 用于表示MDU运行模式配置2//#define MDUMOD0                                  0x01                          //               rw-- MDU模式配置0
 #define MDUMOD1                                  0x02                          //               rw-- 当使能SMDU时, 用于表示MDU运行模式配置1//
 #define MDUMOD0                                  0x01                          //               rw-- 当使能SMDU时, 用于表示MDU运行模式配置0//sfr16   MDU_A                          = 0xc6;                                 // RV:0000H  MDU数据寄存器A
...
/******************************************************************************///FOC
 ...
 #define FOC_ATAN_THETA                 *(_I   int16 xdata *)0x40b2             // RV:0000H  ATAN模式下atan角度，由FOC__EALP/FOC__EBET直接计算
 ...
 #define FOC_ID_LPFK                    *(_IO  uint8 xdata *)0x40c0             // RV:  FFH  FOC ID低通滤波系数
 #define FOC_IQ_LPFK                    *(_IO  uint8 xdata *)0x40c1             // RV:  FFH  FOC IQ低通滤波系数
...
/******************************************************************************///DRV
 ...
 #define PFC_CR2                        *(_IO  uint8 xdata*)0x4063              // RV:  00H  PFC控制寄存器2
 #define PFC_BLK_MD                               0x80                          //               rw-- PFCEN=1时可读
 #define PFC_TRG_MD                               0x40                          //               rw-- PFCEN=1时可读
 ...
 #define PFC_ADCCH                      *(_IO  uint8 xdata*)0x40e1              // RV:  65H  UAC/IAC的ADC通道选择
...
/******************************************************************************///GPIO
 ...
 #define CMPXO_P01                                0x20                          //               rw-- P07比较器输出功能转移-->P01
 #define SPICT                                    0x10                          //               rw-- 单线制SPI功能转移(P05-->P00)
...
/******************************************************************************///ADC
 #define ADC_MASKH                      *(_IO  uint8 xdata *)0x4047             // RV:  00H  ADC通道使能
 #define CH16EN                                   0x01                          //               rw-- ADC通道16使能
 ...
 #define ADC16_DR                       *(_I  uint16 xdata *)0x0ff8             // RV:0000H  ADC通道16转换结果
/*****************************************************************************///DAC
...
/******************************************************************************///AMP
 ...
 #define AMP3M_GND                                0x40                          //               rw-- PGA模式运放3负输入端接GND
...
/******************************************************************************///CMP
 ...
 #define CMP5OUT                                  0x40                          //               r--- CMP5比较结果
 #define CMP3P4M_FS                               0x10                          //               rw-- P27(CMP3P和CMP4M)功能转移至P34
 #define CMP5HYS                                  0x08                          //               rw-- CMP5迟滞使能
